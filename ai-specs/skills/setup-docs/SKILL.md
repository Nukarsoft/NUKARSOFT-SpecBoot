...
- **`base-standards.md`**: mantené los principios generales (tareas pequeñas, TDD, tipado, nombres claros, etc.) y los links a los demás documentos; actualizá cualquier referencia a stack/dominio de ejemplo y reescribí la sección de estándares de idioma según el [Paso 4](#paso-4--reglas-de-idioma).
...
- **`development_guide.md`**: reemplazá los pasos de instalación/ejecución de ejemplo por los reales del proyecto (gestor de paquetes, scripts, variables de entorno, Docker, base de datos, comandos de test, etc.).
- **`documentation-standards.md`**: mantené el proceso de mantenimiento de documentación (qué actualizar y cuándo), ajustando solo la regla de idioma según el [Paso 4](#paso-4--reglas-de-idioma).

### Paso 4 — Reglas de idioma
...
### Paso 5 — Consistencia entre documentos
